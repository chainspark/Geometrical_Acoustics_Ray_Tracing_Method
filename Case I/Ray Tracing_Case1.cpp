...
int main()
{
	...
	ray_tracing_plot.open("Case1_.025_one_wall_250Hz_3mil_100db_cube_analytical_complexR_1_0.csv");

	//Reciever Movement Variables
	double d_step = .05;
	double d_max = 3.0-d_step;
	double d_min = 0.0;
	...
	cout << "\n************************** \nRunning Ray Tracing Algorithm : Case 1\n";
